<template>
    <div class="mywages-info">
        <CSearchForm :dataModel="searchModel" :btnCol="16" textAlign="left"></CSearchForm>
        <Pannel title="武广" padding="0">
...
import { infoWage, dealArr, wagelistmodel, searchModel } from './model/wages';
